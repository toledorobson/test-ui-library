...
import com.migrosone.uilibrary.theme.BasicColors.Basic100
import com.migrosone.uilibrary.theme.BasicColors.Basic300
import com.migrosone.uilibrary.theme.BasicColors.Basic700
import com.migrosone.uilibrary.theme.BasicColors.Basic800
...
fun CampaignEnrollButton(
    ...
    Button(
        ...
        if (icon != null) {
            if (enrolled) {
                Icon(
                    painter = painterResource(R.drawable.migrosone_ui_compose_ic_check),
        ...
        Text(
            text = if (enrolled) {
                stringResource(R.string.migrosone_ui_compose_student_tbg_campaigns_button_verified_success)
            } else {
                buttonText
            },
            color = Basic700
...
private fun CampaignEnrollButtonEnrolledPreview() {
    MigrosTheme(companyType = (MigrosCompanyType.SANALMARKET)) {
        CampaignEnrollButton(
            ...
            enrolled = true,
            icon = R.drawable.migrosone_ui_compose_ic_plus
        )
    }
}
