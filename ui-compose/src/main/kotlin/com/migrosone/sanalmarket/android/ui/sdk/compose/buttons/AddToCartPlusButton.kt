...
fun AddToCartPlusButton(
    ...
    Surface(
        ...
        Box(contentAlignment = Alignment.Center) {
            Icon(
                painter = painterResource(R.drawable.sanalmarket_android_ui_sdk_compose_ic_plus),
                contentDescription = stringResource(R.string.sanalmarket_android_ui_sdk_compose_button_label_add_to_cart),
