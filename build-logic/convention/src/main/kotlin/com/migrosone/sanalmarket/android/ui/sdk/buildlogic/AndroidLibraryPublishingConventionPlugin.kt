package com.migrosone.sanalmarket.android.ui.sdk.buildlogic
...
class AndroidLibraryPublishingConventionPlugin : Plugin<Project> {
    ...
    private fun Project.publishingArtifactId(): String {
        return when (path) {
            ":ui-compose" -> "sanalmarket-android-ui-sdk-compose"
            ":ui-theme" -> "sanalmarket-android-ui-sdk-theme"
    ...
    private fun Project.publishingDescription(): String {
        return when (path) {
            ":ui-compose" -> "Jetpack Compose components for Sanalmarket Android UI SDK."
            ":ui-theme" -> "Migros design system theme tokens for Sanalmarket Android UI SDK."
            else -> error("Publishing is only configured for :ui-compose and :ui-theme.")
        }
    }
}
